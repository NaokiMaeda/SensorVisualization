...
const query = "select HeartRate , Temperture , Humidity , gazeX , gazeY , leftClick , rightClick from testData ORDER BY time DESC limit 1";
...
app.on('ready', function() {
  ...
  mainWindow = new BrowserWindow({width: 380, height: 750});
  ...
  setInterval(function(){
    client.query(query,function(err , result){
      ...
      mainWindow.webContents.send("Temperture" , resultData.Temperture);
